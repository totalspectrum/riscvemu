...
static void vgatext_scrollup(vgatext *self)
{
  memcpy( (void *)self->screenptr, (void *)(void *)((self->screenptr + (VGATEXT_CELL_SIZE * VGATEXT_COLS))), 1*(((VGATEXT_CELL_SIZE * (VGATEXT_ROWS - 1)) * VGATEXT_COLS)));
  memset( (void *)(void *)((self->screenptr + ((VGATEXT_CELL_SIZE * (VGATEXT_ROWS - 1)) * VGATEXT_COLS))), 0, 1*((VGATEXT_CELL_SIZE * VGATEXT_COLS)));
}
